...
int main()
{
	...
	/*setlocale(0, "");
	double num;
	cout << "¬ведите любе число:";
	cin >> num;
	if (num > 10)
		cout << "„ислo больше 10" << endl;
	else
		cout << "„исло меньше или равно 10" << endl;
	system("pause");
	return 0;*/
}